...
class PlantSeedlingV1(DatasetBaseMT):
    
    dataset_dir = "PlantSeedlingV1"
    taskid2type = ['sl']
    ...
    def __init__(self, cfg):
        ...
        self.image_dir = os.path.join(self.dataset_dir, "Nonsegmented")
        self.split_path = os.path.join(self.dataset_dir, "split_dk_PlantSeedlingV1.json")
