...
class KaggleMushroom(DatasetBaseMT):
    
    dataset_dir = "kaggle_mushroom"
    taskid2type = ['sl']
    ...
    def __init__(self, cfg):
        ...
        self.image_dir = os.path.join(self.dataset_dir, "Mushrooms")
        self.split_path = os.path.join(self.dataset_dir, "split_dk_KaggleMushroom.json")
